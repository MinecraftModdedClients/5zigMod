...
public class TournamentQualification
  extends GameModeItem<ServerTimolia.PvP>
{
  ...
  protected Object getValue(boolean dummy)
  {
    ...
    return ((ServerTimolia.PvP)getGameMode()).getTournament().getQualificationRounds() + " " + I18n.translate("ingame.qualification.rounds");
  }
