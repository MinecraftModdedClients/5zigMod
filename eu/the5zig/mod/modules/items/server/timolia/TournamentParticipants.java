  ...
  extends GameModeItem<ServerTimolia.PvP>
{
  ...
  protected Object getValue(boolean dummy)
  {
    ...
    return (((ServerTimolia.PvP)getGameMode()).getTournament() == null) || (((ServerTimolia.PvP)getGameMode()).getTournament().getParticipants() == 0) ? null : Integer.valueOf(((ServerTimolia.PvP)getGameMode()).getTournament().getParticipants());
  }
