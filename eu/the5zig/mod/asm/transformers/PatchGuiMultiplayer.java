...
public class PatchGuiMultiplayer
  implements IClassTransformer
{
  public byte[] transform(String s, String s1, byte[] bytes)
  {
    LogUtil.startClass("GuiMultiplayer (%s)", new Object[] { Names.guiMultiplayer.getName() });
    ...
    extends ClassVisitor
  {
    ...
    public void visitEnd()
    {
      if (!this.patchedGuiClosedMethod)
      {
        ...
        Label l0 = new Label();
        mv.visitLabel(l0);
        mv.visitMethodInsn(184, "BytecodeHook", "onGuiMultiplayerClosed", "()V", false);
        mv.visitInsn(177);
        Label l2 = new Label();
        mv.visitLabel(l2);
      ...
      if (!this.patchedKeyTypedMethod)
      {
        ...
        mv.visitVarInsn(21, 1);
        mv.visitVarInsn(21, 2);
        mv.visitMethodInsn(184, "BytecodeHook", "onGuiMultiplayerKey", "(CI)V", false);
        Label l2 = new Label();
        mv.visitLabel(l2);
    ...
    public MethodVisitor visitMethod(int access, String name, String desc, String signature, String[] exceptions)
    {
      if (Names.initGui.equals(name, desc))
      {
        ...
        return new PatchGuiMultiplayer.PatchInitGui(PatchGuiMultiplayer.this, this.cv.visitMethod(access, name, desc, signature, exceptions));
      }
      if (Names.guiClosed.equals(name, desc))
      {
        this.patchedGuiClosedMethod = true;
        LogUtil.startMethod(Names.guiClosed.getName() + " " + Names.guiClosed.getDesc(), new Object[0]);
        return new PatchGuiMultiplayer.PatchGuiClosed(PatchGuiMultiplayer.this, this.cv.visitMethod(access, name, desc, signature, exceptions));
      }
      if (Names.drawScreen.equals(name, desc))
      {
        LogUtil.startMethod(Names.drawScreen.getName() + " " + Names.drawScreen.getDesc(), new Object[0]);
        return new PatchGuiMultiplayer.PatchDrawScreen(PatchGuiMultiplayer.this, this.cv.visitMethod(access, name, desc, signature, exceptions));
      }
      if (Names.keyTyped.equals(name, desc))
      {
        this.patchedKeyTypedMethod = true;
        LogUtil.startMethod(Names.keyTyped.getName() + " " + Names.keyTyped.getDesc(), new Object[0]);
        return new PatchGuiMultiplayer.PatchKeyTyped(PatchGuiMultiplayer.this, this.cv.visitMethod(access, name, desc, signature, exceptions));
      }
      if (Names.mouseClicked.equals(name, desc))
      {
        ...
        return new PatchGuiMultiplayer.PatchMouseClicked(PatchGuiMultiplayer.this, this.cv.visitMethod(access, name, desc, signature, exceptions));
      }
      LogUtil.endMethod();
    ...
    extends MethodVisitor
  {
    ...
    public void visitInsn(int opcode)
    {
      if (opcode == 177)
      {
        ...
        this.mv.visitVarInsn(25, 0);
        this.mv.visitFieldInsn(180, Names.guiMultiplayer.getName(), "h", "L" + Names.serverSelectionList.getName() + ";");
        this.mv.visitMethodInsn(184, "BytecodeHook", "onGuiMultiplayerInit", "(Ljava/lang/Object;Ljava/lang/Object;)V", false);
      }
    ...
    extends MethodVisitor
  {
    ...
    public void visitInsn(int opcode)
    {
      if (opcode == 177)
      {
        ...
        this.mv.visitMethodInsn(184, "BytecodeHook", "onGuiMultiplayerClosed", "()V", false);
      }
      super.visitInsn(opcode);
    }
  }
    ...
    extends MethodVisitor
  {
    ...
    public void visitInsn(int opcode)
    {
      if (opcode == 177)
      {
        ...
        this.mv.visitMethodInsn(184, "BytecodeHook", "onGuiMultiplayerDraw", "()V", false);
      }
      super.visitInsn(opcode);
    }
  }
    ...
    extends MethodVisitor
  {
    ...
    public void visitInsn(int opcode)
    {
      if (opcode == 177)
      {
        ...
        this.mv.visitMethodInsn(184, "BytecodeHook", "onGuiMultiplayerKey", "(CI)V", false);
      }
      super.visitInsn(opcode);
    }
  }
    ...
    extends MethodVisitor
  {
    ...
    public void visitInsn(int opcode)
    {
      if (opcode == 177)
      {
        ...
        this.mv.visitMethodInsn(184, "BytecodeHook", "onGuiMultiplayerMouseClicked", "(III)V", false);
      }
      super.visitInsn(opcode);
    }
  }
