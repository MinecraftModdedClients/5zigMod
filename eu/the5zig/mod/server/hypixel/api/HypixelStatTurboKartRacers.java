...
public class HypixelStatTurboKartRacers
  extends HypixelStatCategory
{
  ...
  {
    return Arrays.asList(new String[] { parseInt(object, "coins"), parseInt(object, "wins"), parseInt(object, "gold_trophy"), parseInt(object, "silver_trophy"), parseInt(object, "bronze_trophy"), 
