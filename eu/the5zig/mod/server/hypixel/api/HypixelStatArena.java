  ...
  extends HypixelStatCategory
{
  ...
  {
    return Arrays.asList(new String[] { parseInt(object, "coins"), parseDouble(object, "rating"), parseInt(object, "kills_1v1"), parseInt(object, "deaths_1v1"), parseInt(object, "wins_1v1"), 
