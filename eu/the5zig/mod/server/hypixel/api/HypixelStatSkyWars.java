...
public class HypixelStatSkyWars
  extends HypixelStatCategory
{
  ...
  {
    return Arrays.asList(new String[] { parseInt(object, "coins"), parseInt(object, "kills"), parseInt(object, "assists"), parseInt(object, "deaths"), parseInt(object, "wins"), 
