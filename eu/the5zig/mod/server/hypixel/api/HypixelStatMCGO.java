  ...
  extends HypixelStatCategory
{
  ...
  {
    return Arrays.asList(new String[] { parseInt(object, "coins"), parseInt(object, "kills"), parseInt(object, "cop_kills"), parseInt(object, "criminal_kills"), parseInt(object, "deaths"), 
