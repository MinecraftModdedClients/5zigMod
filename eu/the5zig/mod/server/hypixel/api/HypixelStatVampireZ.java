...
public class HypixelStatVampireZ
  extends HypixelStatCategory
{
  ...
  {
    return Arrays.asList(new String[] { parseInt(object, "coins"), parseInt(object, "human_kills"), parseInt(object, "human_deaths"), parseInt(object, "human_wins"), parseInt(object, "vampire_kills"), 
