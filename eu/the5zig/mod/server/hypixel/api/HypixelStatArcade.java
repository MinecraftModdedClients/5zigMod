...
public class HypixelStatArcade
  extends HypixelStatCategory
{
  ...
  {
    return Arrays.asList(new String[] { parseInt(object, "coins"), parseInt(object, "kills_dayone"), parseInt(object, "wins_dayone"), parseInt(object, "headshots_dayone"), 
