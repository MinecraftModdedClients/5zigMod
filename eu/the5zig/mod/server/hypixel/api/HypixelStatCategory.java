...
public abstract class HypixelStatCategory
{
  ...
  {
    return I18n.translate("server.hypixel.stats." + getGameType().getDatabaseName().toLowerCase() + "." + Utils.upperToDash(name));
  }
  ...
  public abstract List<String> getStats(JsonObject paramJsonObject);
}
