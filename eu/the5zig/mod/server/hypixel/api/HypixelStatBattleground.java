...
public class HypixelStatBattleground
  extends HypixelStatCategory
{
  ...
  {
    return Arrays.asList(new String[] { parseInt(object, "coins"), parseString(object, "chosen_class"), parseInt(object, "kills"), parseInt(object, "assists"), parseInt(object, "deaths"), 
