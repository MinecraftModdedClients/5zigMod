...
public class HypixelStatTNTGames
  extends HypixelStatCategory
{
  ...
  {
    return Arrays.asList(new String[] { parseInt(object, "coins"), parseInt(object, "wins_tntrun"), parseInt(object, "wins_tntag"), parseInt(object, "tags_bowspleef"), 
