  ...
  extends Listener
{
  ...
  public void onServerJoin(String host, int port)
  {
    ...
    LastServer config = (LastServer)The5zigMod.getLastServerConfig().getConfigInstance();
    if (host.toLowerCase().endsWith("mcctf.com"))
    {
  ...
  public boolean onServerChat(String message)
  {
    ...
    if ((currentServer instanceof ServerCTF))
    {
      ...
      if ((message.startsWith("Captures: ")) && (this.msgCount == 0))
      {
      ...
      else if ((message.startsWith("Captures: ")) && (this.msgCount == 1))
      {
