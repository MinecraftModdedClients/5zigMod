  ...
  extends GuiMCPVPServers
{
  ...
  public void initGui()
  {
    ...
    addButton(The5zigMod.getVars().createButton(200, getWidth() / 2 - 100, getHeight() / 6 + 168, The5zigMod.getVars().translate("gui.done", new Object[0])));
  }
