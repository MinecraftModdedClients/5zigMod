  ...
  extends FileBase
{
    ...
    throws IOException
  {
    ...
    this.data.touch(this.readOnly);
    this.pos = this.data.readWrite(this.pos, paramByteBuffer.array(), paramByteBuffer.arrayOffset() + paramByteBuffer.position(), i, true);
    ...
    throws IOException
  {
    ...
    long l = this.data.readWrite(this.pos, paramByteBuffer.array(), paramByteBuffer.arrayOffset() + paramByteBuffer.position(), i, false);
